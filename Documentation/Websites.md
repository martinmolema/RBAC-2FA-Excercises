...
Deze menubalk wordt gebruikt om navigatie te bieden voor vijf verschillende websites:
...
Afhankelijk van de website waarvoor de menubalk wordt weergegeven, worden verschillende navigatieopties getoond.
...
## User Provisioning
Er is nog een zesde functionaliteit. Deze voert in de achtergrond processen uit voor User Provisioning. We komen daar
in de oefeningen verder op terug.

## Login Portaal

Het inloggen gebeurt steeds op één centraal punt: het login portaal. Dit zorgt voor een soort Single Sign-On
ervaring doordat de login overgenomen kan worden door de andere websites.
